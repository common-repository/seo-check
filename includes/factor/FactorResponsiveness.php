        ...
        if (isset($data[$key]) && !empty($data[$key])) {
            if (isset($data[$key]['preview']) && !empty($data[$key]['preview'])) {
                if( $key == "phone" ){
                    ...
                    $resolution .= $data[$key]['screen']["width"] . "x" . $data[$key]['screen']["height"];
                }
                ...
                $out .= "  <div class='responsivenesswrapper col-xs-12 col-sm-12 col-md-6 col-lg-6'>"
                        ...
                        . "         <div class='responsivenesslabel col-xs-12 col-sm-5 col-md-4 col-lg-4'>Resolution:</div><div class='responsivenesslabelcontent col-xs-12 col-sm-7 col-md-8 col-lg-8'>" . $resolution . "</div>"

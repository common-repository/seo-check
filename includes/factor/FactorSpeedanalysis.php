    ...
    public static function getDisplay($endModel, $data, $report, $factor) {
        ...
        $html = "
            ...
            "<div class='row' id='speedanalysispiegroup'>
                <div id='' class='col-xs-12 col-sm-12 col-md-12 col-lg-12 nopaddingleft speedanalysispiechartsrequest' data-chartready='false'></div>
                <div id='' class='col-xs-12 col-sm-12 col-md-12 col-lg-12 nopaddingleft speedanalysispiechartsweight' data-chartready='false'></div>

        ...
        if(!empty($data) && !empty($data['latitude']) && !empty($data['longitude']) && !empty($data['address']) && !empty($data['name'])){
            ...
            $html .= '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 nopaddingleft">';
                ...
                $html .= '<div id="bingmapviewer">';
                    ...
                    $html .= '<iframe width="100%" height="400" scrolling="no" frameborder="0" src="https://www.bing.com/maps/embed/viewer.aspx?v=3&cp='. $latitude .'~'. $longitude .'&lvl=15&w=800&h=400&sty=r&typ=d&pp=~'. $address .'~'. $latitude .'~'. $longitude .'&ps=&dir=&mkt=en-us&src=SHELL&form=BMEMJS"></iframe>';
                    
                    $html .= '<div class="bing-prop"><a target="_blank" href="https://www.bing.com/maps/?cp='. $latitude .'~'. $longitude .'&amp;sty=r&amp;lvl=9&amp;sp=&amp;mm_embed=map">View Larger Map</a>&nbsp; |&nbsp; <a target="_blank" href="https://www.bing.com/maps/?cp='. $latitude .'~'. $longitude .'&amp;sty=r&amp;lvl=9&amp;rtp=~pos.'. $latitude .'_'. $longitude .'____&amp;mm_embed=dir">Get Directions</a>&nbsp; |&nbsp; <a target="_blank" href="https://www.bing.com/maps/?cp='. $latitude .'~'. $longitude .'&amp;sty=b&amp;lvl=18&amp;sp=&amp;mm_embed=be">View Bird\'s Eye</a></div>';

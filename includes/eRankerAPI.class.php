...
if (!class_exists("eRankerAPI")) {
    ...
    class eRankerAPI {
         ...
         */
        public function __construct($email, $apikey, $cache = 0, $cachetime = 0, $cachefolder = null) {
            $this->email = $email;
         ...
         * An Error Object can be returned if the code is invalid. 
         */
        public function reportnew($url, $factors,$disable_cache = 1) {
            if (empty($url)) {
                return false;
            }
            if (empty($factors)) {
            ...
            $post_fields['disable_cache'] = $disable_cache;

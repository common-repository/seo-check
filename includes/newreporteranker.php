            ...
            <div class="widget-top seocheck_nomovecursor">
                <div class="widget-title">                    
                    <h4><?php _e('New SEO Report', 'er'); ?> <span class="in-widget-title"></span>
                        <a style="font-size: 12px; font-weight: normal;" class="seocheck_floatrigth seocheck_mariginleft" href="http://www.eranker.com/login" rel="nofollow" target="_blank"><?php _e('Latest Reports', 'er'); ?> <img src="<?PHP echo plugins_url(SEOCHECK_FOLDERNAME . '/images/icon-new-window.gif') ?>" alt="" style="display: inline;"></a>
                    </h4>
                </div>
            </div>

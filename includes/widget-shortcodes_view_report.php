...
class seocheck_view_report_widget extends WP_Widget {
    ...
    function form($instance) {
        ...
        $report_id =    esc_attr((!isset($instance['report_id']) || empty($instance['report_id'])) ? '' : $instance['report_id']);
...
function seocheck_register_view_widget() {
	register_widget( 'seocheck_view_report_widget' );
}


// Add the widget and shortcode to WP
add_action('widgets_init', 'seocheck_register_view_widget');
